"""cmds.py - Implementations of the different Primary Server Load Balancer commands"""
import re
import csv
import json
...
class showSessions(Cmd):
    """Show sess Primary Server Load Balancer command"""
    cmdTxt = "show sess\r\n"
    helpTxt = "Show Primary Server Load Balancer sessions."
